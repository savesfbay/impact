var config = {
    ...
    chapters: [
        ...
        },
        {
            ...
            description: 'In 2016, US Environmental Protection Agency scientists and legal counsel concluded that the vast majority of the Redwood City Salt Ponds is jurisdictional wetlands under the federal Clean Water Act and is protected by that law. Save The Bay and other environmental plaintiffs sued Trump’s EPA in 2019, over its waiver of Clean Water Act jurisdiction on the ponds. The Federal District court ruled in October 2020 that the EPA misapplied the Clean Water Act and ignored its own agency regulations, ordering the Agency to provide a legally sound jurisdictional determination.<br><br>In February 2021, the EPA dropped its appeal of our lawsuit, restoring Clean Water Act protections to the Redwood City Salt Ponds. The move came a week after 57 Bay Area elected officials and organizations asked the Biden Administration to withdraw the Trump EPA appeal of a federal court order upholding those legal protections.<br><br>Save The Bay has fought development on these ponds for 15 years. Now we advocate for Cargill to transfer this sensitive site for addition to the San Francisco Bay National Wildlife Refuge.',
            location: {
                center: [-122.18980, 37.50467],
                zoom: 11.02,
                pitch: 0.00,
